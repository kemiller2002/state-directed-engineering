...
related_documents:
  ...
  - templates/sde/repository-semantic-map.md
  - templates/sde/feature-manifest.md
...
[`templates/sde/repository-semantic-map.md`](../templates/sde/repository-semantic-map.md).
